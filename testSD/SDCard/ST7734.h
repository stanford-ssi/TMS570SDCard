...
extern "C" ST7735* CpushColor(ST7735* cclass, uint16_t color); 
extern "C" ST7735* CsetAddrWindow(ST7735* cclass, uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1); 
extern "C" ST7735* CsetRotation(ST7735* cclass, uint8_t m);
#else
